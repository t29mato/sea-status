function getKumomi() {
  ...
  // spread sheetのシート設定
  var sheet = spreadsheet.getSheetByName(spot_data.Kumomi.sheet_name);
  
  // ダイビングスポット別のAPI-URLの作成
  var fb_api_url = fb_url + spot_data.Kumomi.fb_path + "/feed?access_token=" + access_token + "&limit=" + limit;
